...
describe "/grammar_items/edit.html.erb" do
  ...
  it "renders the edit grammar_item form" do
    render
    
    # response.should have_tag("form[action=#{grammar_item_path(@grammar_item)}][method=post]") do
